...
class FirmAgent:
    ...
    async def morph(self, business_label=""):
        ...
        system = (
            ...
            "CRITICAL — there are THREE layers, not two, and confusing them is how a firm ends "
            "up only automating paperwork:\n"
            "1. DRUDGERY the owner complains about (re-typing, transcribing, copying between "
            "tools) — REMOVE it entirely.\n"
            "2. The MECHANICAL/VOLUME layer of their skilled CORE work — culling thousands of "
            "photos, typing a first draft, pre-screening, sorting — AI does this heavy first pass; "
            "this is often the BIGGEST opportunity and you must NOT shy away from it just because "
            "the work is skilled.\n"
            "3. The JUDGMENT layer — the final creative or professional decision (which photos are "
            "the keepers, the legal call, the diagnosis) — the human KEEPS this.\n"
            "Respect means keeping them in control of the final judgment (#3) while aggressively "
            "lifting BOTH the drudgery (#1) AND the heavy volume of their core craft (#2) off "
            "them. Do not protect #2 as if it were #3 — that is how you end up recommending "
            "nothing but back-office automation and never touching the work they are paid for.\n\n"
